...
/**
 * Tab della Documentazione MIFID che mostra e gestisce i documenti MIFID
 * 
 * Questa componente mostra:
 * - Sezione per generare documenti MIFID
 * - Opzioni di firma digitale e tradizionale
 * - Sezione per caricare documenti firmati
 * - Tabella dei documenti verificati
 */
export function MifidDocsTab({ 
  clientId, 
  onShowPdfDialog, 
  onDigitalSignature, 
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {/* Document Generation and Upload Section - Side by Side */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Generate Documents Section */}
              <div className="border rounded-md p-6">
                <h3 className="text-lg font-medium mb-2 flex items-center gap-2">
                  <PenLine className="h-4 w-4 text-blue-500" />
                  {t('client.generate_documents') || "Genera Documenti MIFID"}
                </h3>
            ...
            <div className="pt-4 border-t">
              <h3 className="text-lg font-medium mb-4 flex items-center gap-2">
                ...
                {t('client.verified_documents') || "Documenti Verificati"}
              </h3>
