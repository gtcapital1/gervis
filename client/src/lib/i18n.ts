...
const resourcesEn = {
  translation: {
    ...
    pdf: {
      ...
      clientSummaryReport: "Client Financial Summary Report",
      ...
      disclaimerText: "This financial summary is provided for informational purposes only and does not constitute a recommendation or solicitation to buy or sell any investment product. The information contained herein is based on data provided by the client and is believed to be reliable. Past performance is not a guarantee or a reliable indicator of future results. Investment strategies involve risk, and the value of investments can go up or down. Investors should consult with their financial advisor before making any investment decisions.",
      page: "Page",
      of: "of",
...
const resourcesIt = {
  translation: {
    ...
    pdf: {
      ...
      clientSummaryReport: "Rapporto Finanziario del Cliente",
      generatedOn: "Generato il",
      clientInformation: "Informazioni Cliente",
      assetsInformation: "Informazioni Patrimoniali",
      name: "Nome Completo",
      email: "Email",
      phone: "Telefono",
      address: "Indirizzo",
      ...
      advisorSignature: "Firma del Consulente",
      clientSignature: "Firma del Cliente",
      disclaimer: "Avvertenze e Note Importanti",
      disclaimerText: "Questo riepilogo finanziario è fornito esclusivamente a scopo informativo e non costituisce una raccomandazione o una sollecitazione all'acquisto o alla vendita di qualsiasi prodotto di investimento. Le informazioni contenute nel presente documento sono basate sui dati forniti dal cliente e sono ritenute affidabili. I risultati passati non costituiscono una garanzia o un indicatore affidabile dei risultati futuri. Le strategie di investimento comportano rischi e il valore degli investimenti può sia aumentare che diminuire. Gli investitori dovrebbero consultare il proprio consulente finanziario prima di prendere qualsiasi decisione di investimento.",
      page: "Pagina",
      of: "di",
