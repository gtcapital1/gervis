...
const resourcesEn = {
  translation: {
    ...
    pdf: {
      ...
      clientDeclarationText: "I hereby declare that the information provided is true, complete and accurate. This summary represents my current financial situation and personal information as reported to my financial advisor.",
      date: "Date",
      page: "Page",
      of: "of",
