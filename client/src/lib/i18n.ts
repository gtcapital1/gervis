...
const resourcesEn = {
  translation: {
    ...
    pdf: {
      ...
      clientDeclarationText: "I hereby declare that the information provided is true, complete and accurate. I understand the investment strategy proposed and the associated risks.",
      date: "Date",
      page: "Page",
      of: "of",
...
const resourcesIt = {
  translation: {
    ...
    pdf: {
      ...
      clientDeclarationText: "Dichiaro che le informazioni fornite sono vere, complete e accurate. Comprendo la strategia di investimento proposta e i rischi associati.",
      date: "Data",
      page: "Pagina",
      of: "di",
